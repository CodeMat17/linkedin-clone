  ...
  return (
    <Backdrop onClick={handleClose}>
      ...
      {type === "gifYouUp" && (
        <motion.div
          onClick={(e) => e.stopPropagation()}
          className='rounded-lg overflow-hidden flex flex-col items-center justify-center bg-[#1D2226] -mt-[2vh] mx-6'
          variants={gifYouUp}
          initial='hidden'
          animate='visible'
          exit='exit'>
          <motion.img
            ...
            src={post.photoUrl}
            className='object-contain max-h-[50vh] max-w-3xl'
          />
          <div className='w-full bg-white dark:bg-[#1D2226]'>
